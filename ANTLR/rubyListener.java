...
public interface rubyListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link rubyParser#content_case}.
	 * @param ctx the parse tree
	 */
	void enterContent_case(rubyParser.Content_caseContext ctx);
	/**
	 * Exit a parse tree produced by {@link rubyParser#content_case}.
	 * @param ctx the parse tree
	 */
	void exitContent_case(rubyParser.Content_caseContext ctx);
	/**
